    ...
    return(
        <Container minH={"100vh"} h={"100%"} minW={"full"} w={"full"} py={10}>
            ...
            <Box display={"flex"} alignItems={"center"} justifyContent={"center"}>
                ...
                <Box rounded={"lg"} shadow={useColorModeValue("md", "md")} w={"full"} maxW={"6xl"} bg={useColorModeValue("rgb(254, 244, 226)", "gray.800")} p={5} h={"100vh"}>

                    <Box display={"flex"} h={"full"} rounded={"lg"} overflow={"hidden"}>
